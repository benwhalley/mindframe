...
class LLMToolsTestCase(TestCase):
    ...
    def test_chatter_joke(self):
        jk = chatter("Think about mammals very briefly, in one or 2 lines: [[THOUGHTS]] Now tell me a joke. [[speak:JOKE]]", self.mini)
    ...
    def test_chatter_topic_choice(self):
        rr = chatter("Which is more interesting for nerds: art, science or magic? [[pick:topic|art,science,magic]]", self.mini)
