...
from mindframe.models import Judgement, JudgementReturnType, Intervention, TreatmentSession, Cycle, CustomUser, Note
...
therapist	00:00:55	Okay. Would you like to talk more about that?"""
        ...
        cls.brief_judgement_return_type = JudgementReturnType.objects.create(schema=brief_note_schema, title="BriefNote")
