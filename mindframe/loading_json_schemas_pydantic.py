...
def pydantic_model_from_schema(schema_string):
...
extract_struct = prompt_function_factory(
    pydantic_model_from_schema(nt), 
    "Make a clinical note of this conversation:\n{input_value}\nRespond in JSON"
)


extract_struct("""therapist	00:00:02	You did your values clarification handout, and that was part of what I wanted to go over with you today. I wanted to hear about your values and just talk to you a little bit more about that. Do-do you wanna tell me what some of your top five values are?
